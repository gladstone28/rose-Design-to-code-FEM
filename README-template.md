...
This is the place to go to learn markdown [The Markdown Guide](https://www.markdownguide.org/).


### Continued development

The more challenges I do contrbutes to my increased knowledge. My expertise in the use of VS Studio Code has also improved dramatically


### Useful resources

- [Example resource 1](https://www.figma.com) - This helped me in converting the design to code.
